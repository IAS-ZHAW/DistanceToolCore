...
public class TestComplexDoubleMatrix extends TestCase {
	...
	public void testLargeManhattan() throws IOException {
		...
		assertEquals(dist, Matrix.readFromFile(new File("./testdata/m10x10mul-manhattan.csv"), ';'));
		
		m = Matrix.readFromFile(new File("./testdata/m10x10add.csv"), ';');
		dist = DistanceTestCaseHelper.compareNormalParallel(this, new ManhattanDist(), m);
		assertEquals(dist, Matrix.readFromFile(new File("./testdata/m10x10add-manhattan.csv"), ';'));
	}	
	
	public void testLargeCanberra() throws IOException {
	  Matrix m = Matrix.readFromFile(new File("./testdata/m10x10add.csv"), ';');
    Matrix dist = DistanceTestCaseHelper.compareNormalParallel(this, new CanberraDist(), m);
  ...
  public void testLargeEuklid() throws IOException {
    ...
    Matrix dist = DistanceTestCaseHelper.compareNormalParallel(this, new EuklidianDist(), m);
